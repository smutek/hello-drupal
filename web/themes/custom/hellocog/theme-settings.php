 ...
 */
function hellocog_form_system_theme_settings_alter(&$form, FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['hellocog_example'] = [
  '#type'          => 'checkbox',
  '#title'         => t('hellocog sample setting'),
  '#default_value' => theme_get_setting('hellocog_example'),
